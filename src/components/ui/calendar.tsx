...
import { formatDateToInputStr, MONTHS_SHORT_SV } from "@/lib/date-utils";
...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      formatters={{
        formatMonthDropdown: (date) => MONTHS_SHORT_SV[date.getMonth()],
        ...formatters,
      }}
      classNames={{
...
function CalendarDayButton({
  ...
  return (
    <Button
      ...
      variant="ghost"
      size="icon"
      data-day={formatDateToInputStr(day.date)}
