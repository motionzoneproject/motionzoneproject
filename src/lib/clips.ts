// Klipp- och tillfällessaldo. Ligger medvetet utanför en "use server"-fil:
// varje export i en sådan blir en publik endpoint, och det här är en
// muterande hjälpare som bara ska gå att nå inifrån serverkod som redan
// gjort sin behörighetskontroll.
